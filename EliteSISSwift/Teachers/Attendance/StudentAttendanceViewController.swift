...
class StudentAttendanceViewController: UIViewController {
    ...
    func callForDropDownData() {
        ...
        DispatchQueue.global().async {
            ...
            let stringLoginCall = Constants.BASE_URL + Constants.API.getAttendance + self.regid  + Constants.SchoolID
            print("Attendance URL: \(stringLoginCall)")
    ...
    func callForStudentList()  {
        ...
        DispatchQueue.global().async {
            ...
            let stringLoginCall = Constants.BASE_URL + Constants.API.getAttendance + self.StrSectionID + Constants.SchoolID
            print("Attendance URL: \(stringLoginCall)")
...
extension StudentAttendanceViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func configTableView(){
        ...
        self.tblView.register(UINib(nibName: Constants.Nib.NibIdentifier.studentAttendanceTableViewCell, bundle: Bundle.main), forCellReuseIdentifier: Constants.Nib.ReusableIdentifier.studentAttendanceTableViewCell)
        self.tblView.register(UINib(nibName: Constants.Nib.NibIdentifier.studentAttendanceHeaderFooterView, bundle: Bundle.main), forHeaderFooterViewReuseIdentifier: Constants.Nib.ReusableIdentifier.studentAttendanceHeaderFooterView)
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let headerView = tableView.dequeueReusableHeaderFooterView(withIdentifier: Constants.Nib.ReusableIdentifier.studentAttendanceHeaderFooterView) as! StudentAttendanceHeaderFooterView
        return headerView
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        
        let cell = tableView.dequeueReusableCell(withIdentifier: Constants.Nib.ReusableIdentifier.studentAttendanceTableViewCell) as! StudentAttendanceTableViewCell
